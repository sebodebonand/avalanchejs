...
import { ContractVMAPI } from './apis/contractvm/api';
...
export default class Avalanche extends AvalancheCore {
  ...
  /**
     ...
     * otherwise default "2oYMBNV4eNHyqk2fjjV5nVQLDbtmNJzq5s3qs3Lo6ftnC6FByM"
     * @param CChainID Sets the blockchainID for the CVM. Will try to auto-detect,
...
export * as contractvm from './apis/contractvm';
